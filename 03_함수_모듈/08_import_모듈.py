...
둘다 math라는 곳에서 기능을 가져온 건데 문제가 되지 않나요? -> 문제 X

sqrt는 math.을 앞에 붙이지 않고 작성할 것이다.
...
from math import sqrt # math 안에서 sqrt라는 기능만 가져와서 사용하겠다.import
print(sqrt(16)) # 대놓고 math에서 sqrt만 가져와서 사용한다 했기 때문에 math. 을 생략
