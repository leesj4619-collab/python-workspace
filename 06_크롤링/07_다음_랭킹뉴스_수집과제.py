...
url = "https://v.daum.net/v/20260428121416727"
...
def url목록가져오기():
    ...
    # 힌트: 크롬 개발자도구(F12) 로 기사 링크 태그 확인 후 작성
    # TODO: soup.select() 로 기사 링크 태그 전부 찾기
    태그들 = soup.select('a.link._thumb')
    # 태그들 = soup.findAll('a.link._thumb')
