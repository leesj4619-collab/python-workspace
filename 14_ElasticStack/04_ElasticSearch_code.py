...
# id = primary Key와 동일 id를 작성하지 않으면 엘라스틱서치에서 자동으로 번호 부여
# document는 컬럼 데이터를 저장할 JSON 데이터
...
'''
(관계형 베이스데이터)RDS 표 테이블 구조 Elasticsearch JSON 문서 구조
표 테이블보다 JSON으로 되어있는 것이 읽는 속도가 더 빠름
