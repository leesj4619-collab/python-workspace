from transformers import pipeline, ElectraTokenizer, ElectraForSequenceClassification, MarianTokenizer, MarianMTModel

'''
pipeline = 허깅페이스가 만든 올인원 간편도구
...
def 번역1():
    번역모델 = pipeline(
        #'translation', 최신버전에선 translation 대신 translation_ko_to_en 사용
...
def 번역2():
    ...
    글자 = ('안녕하세요. 저는 OpenAI가 개발한 AI 비서 ChatGPT입니다. '
          '사용자의 질문에 답변하고, 학습을 돕고, 문서를 작성하며, '
          '프로그래밍과 문제 해결을 지원하는 것이 제 역할입니다. '
          '다양한 분야의 정보를 이해하고 자연스러운 대화를 통해 도움을 제공할 수 있습니다.')
