...
torch 와 tensorflow는 하는 일은 같지만 딥러닝 프레임워크를 만든 회사가 다르다.
         TensorFlow            PyTorch
만든곳      구글               페이스북(Meta)
별 명       TF                 torch
...
classifier = pipeline(
    ...
    model='snunlp/KR-FinBert-SC' # 한국어 감정분석 모델 - 허깅페이스가 만듦
)
'''
...
허깅페이스
프랑스 개발자 = 클레망 델랑그, 줄리앙 쇼몽, 토마 울프 3명이 2016년 만듦
처음에는 AI 회사가 아니었다.
2016년에 10대 청소년용 챗봇 앱을 만들고 친구처럼 대화하는 앱을 만들자! 잘 되지 않았음
챗봇 만들면서 쓴 AI기술을 오픈 소스로 공개
...
리뷰 : 이 영화 진짜 최고
결과 : neutral / 확신도 : 98.3%
리뷰 : 너무 지루했음 돈과 시간을 같이 버림
결과 : neutral / 확신도 : 99.6%
리뷰 : 배우 연기는 좋은데 스토리가 별로다
결과 : neutral / 확신도 : 99.7%
'''