...
완성된 기계 뇌를 만들 때도
pkl을 사용하는 것이 아니라
keras 확장자 명칭이나 h5와 같은 확장자 명칭을 선호
'''
...
model = Sequential([
    ...
    # 한줄정렬 형태로 만들어서 계싼처리를 원활하도록 하겠다.
    Dense(128,activation='relu'),  # 보통 64나 126 256 숫자범위로 많이 시작
...
#             metrics = 학습하면서 정확도 측정 / metrics 작성하지 않으면 loss만 보임
model.compile(optimizer='adam',
              loss='sparse_categorical_crossentropy',
              metrics=['accuracy'])

# X_train = 문제지 이미지 60000장
# y_train = 정답지 0~9 숫자
...
mnist정확도 : 98.0%
1875/1875 ━━━━━━━━━━━━━━━━━━━━ 3s 1ms/step - accuracy: 0.9987 - loss: 0.0037
accuracy loss가 NaN 뜨면  Sequential 식이 문제가 있음
'''