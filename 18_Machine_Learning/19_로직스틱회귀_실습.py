...
def 로지스틱기능(데이터,name,max_iter=1000):
...
로지스틱기능(load_iris(),'붓꽃')
로지스틱기능(load_wine(),'와인')
로지스틱기능(load_digits(),'손글씨',max_iter=5000) # 기본값 1000 대신 5000사용

model_iris = 로지스틱기능(load_iris(),'붓꽃')
model_wine = 로지스틱기능(load_wine(),'와인')
model_digits = 로지스틱기능(load_digits(),'손글씨',max_iter=5000) # 기본값 1000 대신 5000사용
